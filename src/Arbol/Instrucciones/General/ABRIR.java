 ...
 * @author Fernando
 */
public class ABRIR extends Instruccion {
    ...
    public ABRIR(LinkedList<Expresion> path, int fila, int columna) {
        this.path = path;
        this.fila = fila;
    ...
    public Object Ejecutar(Entorno tablasimbolos) {
        ...
        try {
            Display.bw = new BufferedWriter(new FileWriter(Display.archivo_abrir, false));
